		...
		<view class="login-form">
			...
			<view>
				<view class="form-input">
					<input v-model='loginName' type="text"  placeholder="统一身份认证平台用户名" />
				</view>
				<view class="form-input">
					<input v-model='password'  placeholder="统一身份认证平台用密码" password="true" />
				</view>
				<button type="warn" size="default" form-type="submit" @click="formSubmit">微信绑定登录</button>
			</view>
		</view>
	</view>
</template>
